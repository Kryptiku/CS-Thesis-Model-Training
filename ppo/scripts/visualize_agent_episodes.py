...
if __name__ == "__main__":
    ...
    PRNG_MODEL = os.path.join(MODELS_DIR, "ppo_prng_1")
    QRNG_MODEL = os.path.join(MODELS_DIR, "ppo_qrng_1")
    ...
    parser = argparse.ArgumentParser(
        description='Generate GIFs of PPO agents traversing ENTIRE evaluation set (all 1000 episodes per condition)',
  ...
  python visualize_agent_episodes.py --output "C:/my/folder"
    ...
    if args.output:
        ...
        output_dir = os.path.join(BASE_DIR, "ppo", "outputs", "episode_gifs")
