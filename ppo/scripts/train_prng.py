...
if __name__ == "__main__":
    ...
    MODEL_SAVE_PATH = os.path.join(PPO_DIR, "models", "PPO_20x20_Manhattan (MAIN) PRNG - 19 UNIQUE MAZES")
    LOG_FILE = os.path.join(PPO_DIR, "outputs", "training_logs", "training_log_prng.csv")
    ...
    MODEL_NAME = "PPO_20x20_Manhattan (MAIN) PRNG - 19 UNIQUE MAZES"
