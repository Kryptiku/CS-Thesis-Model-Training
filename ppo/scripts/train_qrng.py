...
if __name__ == "__main__":
    ...
    MODEL_SAVE_PATH = os.path.join(PPO_DIR, "models", "PPO_20x20_Manhattan (MAIN) QRNG - 19 UNIQUE MAZES")
    LOG_FILE = os.path.join(PPO_DIR, "outputs", "training_logs", "training_log_qrng.csv")
    REPORT_DIR = os.path.join(PPO_DIR, "outputs", "training_reports")
