"""
Comprehensive A2C Agent Evaluation Script
Evaluates both PRNG and QRNG trained A2C agents on novel mazes with:
- Success Rate % (SR)
...
class EvaluationRunner:
    def __init__(self, prng_model_path, qrng_model_path, prng_seeds_csv, qrng_seeds_csv):
        ...
        print("\n" + "="*70)
        print("LOADING A2C MODELS AND SEEDS")
        print("="*70)

        try:
            self.prng_model = A2C.load(prng_model_path)
            print(f"✅ Loaded PRNG A2C model")
        except Exception as e:
            print(f"❌ Error loading PRNG model: {e}")
            raise

        try:
            self.qrng_model = A2C.load(qrng_model_path)
            print(f"✅ Loaded QRNG A2C model")
        except Exception as e:
...
<html>
<head>
    <title>A2C Agent Evaluation Report</title>
    <style>
    ...
    <div class="container">
        ...
        <div class="metrics-grid">
            ...
            <div class="metric-card qrng">
                <div class="metric-label">QRNG A2C Model - Intra SR %</div>
                <div class="metric-value">{results['qrng_on_qrng']['success_rate']:.1f}%</div>
                <div class="metric-sublabel">(Novel QRNG mazes)</div>
            </div>
            <div class="metric-card qrng">
                <div class="metric-label">QRNG A2C Model - Cross SR %</div>
        ...
        <table class="summary-table">
            ...
            <tr>
                <td><strong>PRNG A2C Model</strong></td>
            ...
            <tr>
                <td><strong>QRNG A2C Model</strong></td>
                <td>Novel QRNG Mazes</td>
        ...
        <div class="comparison-section">
            ...
            <table class="summary-table">
                ...
                <tr>
                    <td><strong>PRNG A2C Agent</strong></td>
                    <td>{results['prng_on_prng']['success_rate']:.2f}%</td>
                    <td>{results['prng_on_qrng']['success_rate']:.2f}%</td>
                ...
                <tr>
                    <td><strong>QRNG A2C Agent</strong></td>
                    <td>{results['qrng_on_qrng']['success_rate']:.2f}%</td>
                    <td>{results['qrng_on_prng']['success_rate']:.2f}%</td>
        ...
        <div class="highlight">
            <p>Lower steps = more efficient pathfinding. Optimal paths for 20x20 maze: 40-50 steps.</p>
            <ul>
...
if __name__ == "__main__":
    ...
    try:
        ...
        print(f"🔷 QRNG A2C Agent (Novel Mazes):")
